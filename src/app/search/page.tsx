          ...
          <div className="mx-auto max-w-5xl px-4 py-24 sm:py-32">
            ...
            <Reveal delay={300}>
              <Link href="/enterprise">
                <div
                  className={`mt-8 group relative overflow-hidden rounded-2xl border transition-all duration-300 cursor-pointer ${
                    isDark
                      ? 'border-gray-700 bg-gradient-to-r from-gray-800/80 via-indigo-900/20 to-gray-800/80 hover:border-indigo-500/50 hover:shadow-xl hover:shadow-indigo-500/10'
                      : 'border-gray-200 bg-gradient-to-r from-white via-indigo-50/50 to-white hover:border-indigo-400 hover:shadow-xl hover:shadow-indigo-400/10'
                  }`}
                >
                  <div className="relative p-6 sm:p-8 flex items-center gap-6">
                    <div className={`w-12 h-12 rounded-xl flex-shrink-0 flex items-center justify-center transition-colors ${isDark ? 'bg-indigo-500/20 group-hover:bg-indigo-500/30' : 'bg-indigo-100 group-hover:bg-indigo-200'}`}>
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className={`text-lg font-bold group-hover:text-indigo-500 transition-colors ${isDark ? 'text-white' : 'text-gray-900'}`}>
                    ...
                    <svg className={`w-5 h-5 flex-shrink-0 transition-transform group-hover:translate-x-1 ${isDark ? 'text-gray-500 group-hover:text-indigo-400' : 'text-gray-400 group-hover:text-indigo-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
