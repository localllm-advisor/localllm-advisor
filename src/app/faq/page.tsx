...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Benchmark scores come from the Open LLM Leaderboard on HuggingFace, which uses standardized evaluation. Benchmarks include: IFEval (instruction following), BBH (reasoning), MATH (math), GPQA (science), HumanEval/MBPP/BigCodeBench (coding). We update data periodically - see our GitHub for last update.',
  },
  {
    category: 'tool',
    question: 'Why is my GPU not in the list?',
    answer: 'We maintain a curated list of popular GPUs. If yours is missing, use "Manual Entry" to input your VRAM and bandwidth specs (check your GPU\'s spec sheet). Want to add a GPU? Submit a pull request on GitHub with the specs, or open an issue.',
  },
  {
    category: 'tool',
    question: 'Can I contribute to this project?',
    answer: 'Yes! LocalLLM Advisor is open source. You can: 1) Add GPUs/CPUs to our database, 2) Update model data, 3) Improve calculations, 4) Fix bugs, 5) Suggest features. Check our GitHub repo for contribution guidelines.',
  },
];
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-12 p-6 rounded-xl bg-gray-800/50 border border-gray-700 text-center">
          ...
          <p className="text-gray-400 text-sm mb-4">
            Check our methodology page for technical details, or open an issue on GitHub.
          </p>
          <div className="flex justify-center gap-4">
            ...
            <a
              href="https://github.com/localllm-advisor/localllm-advisor/issues"
              target="_blank"
